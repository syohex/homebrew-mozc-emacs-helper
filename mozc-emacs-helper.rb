...
class MozcEmacsHelper < Formula
  ...
  def install
    ...
    system "patch mozc/src/build_mozc.py < build_mozc.py.patch"
    system "python mozc/src/build_mozc.py gyp --noqt"
    system "python mozc/src/build_mozc.py build -c Release mozc/src/mac/mac.gyp:GoogleJapaneseInput mozc/src/mac/mac.gyp:gen_launchd_confs mozc/src/unix/emacs/emacs.gyp:mozc_emacs_helper"
